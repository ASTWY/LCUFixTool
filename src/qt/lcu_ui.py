...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_9.setGeometry(QRect(30, 20, 61, 21))
        font10 = QFont()
        font10.setFamilies(["\u5fae\u8f6f\u96c5\u9ed1"])
        font10.setPointSize(12)
        font10.setBold(True)
        self.label_9.setFont(font10)
        self.message = QLabel(self.notification_frame)
        self.message.setObjectName("message")
        self.message.setGeometry(QRect(30, 40, 311, 81))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_13.setText(
            QCoreApplication.translate(
                "MainWindow",
                '<html><head/><body><p>\u672c\u5de5\u5177\u7531 <a href="https://space.bilibili.com/86332521" target="_blank"><span style=" text-decoration: underline; color:#00ff7f;">@\u827e\u65af\u6258\u7ef4\u4e9a</span></a> \u63d0\u4f9b\u6280\u672f\u652f\u6301</p></body></html>',
                None,
            )
        )
